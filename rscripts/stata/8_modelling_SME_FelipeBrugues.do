...
* NO IV
xtivreg2 log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 [aweight = n_sect], cluster(scian_code) fe robust

* NO IV + industry_year
xtivreg2 log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 i(industry_year) [aweight = n_sect], cluster(scian_code) fe robust


*xtivreg log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex  santander hsbc inbursa scotiabank banorte  a2016 a2017 a2018 a2019 a2020 (wa_interest_rate_d = i_other_sector), fe vce(cluster scian_code)


* IV 
xtivreg2 log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 (wa_interest_rate_d = i_other_sector) [aweight = n_sect], cluster(scian_code) fe robust
...
quietly xtivreg2 log_mean_disposition  wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 x11_2016-x93_2021 (wa_interest_rate_d = i_other_sector) [aweight = n_sect], cluster(scian_code) fe robust
