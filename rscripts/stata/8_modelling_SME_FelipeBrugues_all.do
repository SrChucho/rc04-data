...
* Importing data
import delimited "$Path/Data/proc/panel_firms_G7all.csv"
...
* NO IV
quietly xtivreg2 log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 firm_size [aweight = n_sect], cluster(scian_code) fe robust
...
* NO IV + industry_year
quietly xtivreg2 log_mean_disposition wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 x11_2016-x93_2021 firm_size [aweight = n_sect], cluster(scian_code) fe robust
...
* IV + industry year
quietly xtivreg2 log_mean_disposition wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 x11_2016-x93_2021 firm_size (wa_interest_rate_d = i_other_sector) [aweight = n_sect], cluster(scian_code) fe robust first
...
quietly xtivreg2 log_mean_disposition log_wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte a2016 a2017 a2018 a2019 a2020 x11_2016-x93_2021 firm_size (log_wa_interest_rate_d = log_i_other_sector) [aweight = n_sect], cluster(scian_code) fe robust first
