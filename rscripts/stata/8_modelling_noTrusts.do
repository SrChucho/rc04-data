...
* Importing data
import delimited "$Path/Data/proc/panel_firms_G7noTrust.csv"
...
*calculate sample mean for log_wa_interest_rate_d
...
*****************************************************
** Column 1 -- log mean_disposition, log wa_interest_rate_d
*****************************************************
...
esttab using "results/reg1_noTrust.tex", indicate("Sector effects = a2016" "Year effects = a2018") replace nonotes substitute(\_ _) nogaps compress b(a3) se(a3) ar2(a3) star(* 0.10 ** 0.05 *** 0.01) eqlabel(none) nodep label keep(wa_interest_rate_d wa_term_d inflation citibanamex santander hsbc inbursa scotiabank banorte) coeflabel(wa_interest_rate_d "Interest rate" wa_term_d "Term" inflation "Inflation rate" citibanamex "Citibanamex" santander "Santander" hsbc "HSBC" inbursa "Inbursa" scotiabank "Scotiabank" banorte "Banorte") mtitle("Log Loan Amount") scalars("a \hline" "elas \hspace{5mm} Elasticidad precio" "elas_SE \hspace{5mm} Std. Err.") sfmt(a3)
